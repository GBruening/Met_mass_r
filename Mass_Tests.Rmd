...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Average over trials.'}
plot_grid(miss_dist_avg[['pref']]+theme(legend.position = 'none'),
          miss_dist_avg[['smallt']]+theme(legend.position = 'none'),
...
```{r missdistvartplot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist SD over trials.'}
plot_grid(miss_dist_sd[['pref']]+theme(legend.position = 'none'),
          miss_dist_sd[['smallt']]+theme(legend.position = 'none'),
          miss_dist_sd[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
          align = 'vh',
          labels = c('2a','2b','2c'))
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Angle Average over trials.'}
plot_grid(miss_ang_avg[['pref']]+theme(legend.position = 'none'),
          miss_ang_avg[['smallt']]+theme(legend.position = 'none'),
          miss_ang_avg[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
          align = 'vh',
          labels = c('2a','2b','2c'))
```
...
```{r missangvartplot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist standard deviation over trials.'}
plot_grid(miss_ang_sd[['pref']]+theme(legend.position = 'none'),
          miss_ang_sd[['smallt']]+theme(legend.position = 'none'),
          miss_ang_sd[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
          align = 'vh',
          labels = c('2a','2b','2c'))
```
...
```{r missangvartplotmet, echo = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist standard deviation over trials for metabolic experiment.'}
miss_dist_sd[['metabolic']]
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Rad Average over trials.'}
plot_grid(miss_rad_avg[['pref']]+theme(legend.position = 'none'),
          miss_rad_avg[['smallt']]+theme(legend.position = 'none'),
          miss_rad_avg[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
          align = 'vh',
          labels = c('2a','2b','2c'))
```
...
```{r missradvartplot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist standard deviation over trials.'}
plot_grid(miss_ang_sd[['pref']]+theme(legend.position = 'none'),
          miss_ang_sd[['smallt']]+theme(legend.position = 'none'),
          miss_ang_sd[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
