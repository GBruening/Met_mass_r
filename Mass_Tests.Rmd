...
variability_trial_plot <- function(data, variable, add_or_plot){
  if (add_or_plot=='add'){
    ...
    for (k in 11:(length(data$subj)-10)){
      if (var(data[(k-10):(k+10),'eff_mass'])==0){
        if ('speed' %in% colnames(data) && var(data[(k-10):(k+10),'speed'])==0){
          data[k,paste(variable,'_variance',sep='')] = sd(data[(k-10):(k+10),variable])
        } else {
          data[k,paste(variable,'_variance',sep='')] = sd(data[(k-10):(k+10),variable])
        }
      } else {
        data[k,paste(variable,'_variance',sep='')] = NaN
      }
    }
  ...
  if (add_or_plot=='plot'){
    eval(parse(text = paste('data$yvar = data$',variable,'_variance',sep='')))
    g<-ggplot(data=data)+
      geom_smooth(aes(x=trial,
                      y=yvar,
                      color = factor(subj)))+
      theme_classic()+
      labs(x = 'Trial Number', y = paste('Variance (',variable,')',sep=''),color = 'Subject')
...
for (variable in c('miss_dist','miss_rad','missangle')){
  prefdata <- variability_trial_plot(prefdata,variable,'add')
  smalltdata <- variability_trial_plot(smalltdata,variable,'add')
  pilotdata <- variability_trial_plot(pilotdata,variable,'add')
  metdata <- variability_trial_plot(metdata,variable,'add')
}
...
### Miss Variance over trials
```{r, echo = FALSE, warning = FALSE, message = FALSE}
miss_dist_vart = list()
miss_dist_vart[['pref']] <- variability_trial_plot(prefdata,'miss_dist','plot')
miss_dist_vart[['smallt']] <- variability_trial_plot(smalltdata,'miss_dist','plot')
miss_dist_vart[['pilot']] <- variability_trial_plot(pilotdata,'miss_dist','plot')
miss_dist_vart[['metabolic']] <- variability_trial_plot(metdata,'miss_dist','plot')
```

Table \@ref{tab:missvartrialtab} shows the average variance values for experiment 2a, 2b, and 2c. These are calculated from a 20 trial window variance, then averaged over all points.

```{r missvartrialtab, echo = FALSE, warning = FALSE, message = FALSE}
tab = cbind(aggregate(miss_dist_variance ~ eff_mass,prefdata,mean)$miss_dist_variance,
            aggregate(miss_dist_variance ~ eff_mass,smalltdata,mean)$miss_dist_variance,
            aggregate(miss_dist_variance ~ eff_mass,pilotdata,mean)$miss_dist_variance)
# tab = formatC(tab,format = 'e', digits = 3)
rownames(tab) = unique(prefdata$eff_mass)
colnames(tab) = c('2a','2b','2c')
kable(tab, caption = 'Average Variance by mass and experiment.')

```

Table \@ref{tab:missvartrialtabmet} shows the average variance values for experiment 1.

```{r missvartrialtabmet, echo = FALSE, warning = FALSE, message = FALSE}

miss_dist_tab = table_func_nosd(metdata, 'miss_dist_variance')
kable(miss_dist_tab, caption = 'Average Endpoint Error Variance for the metabolic experiment')

```

This next plot (fig \@ref{fig:missdistvartplot}) shows the variance of miss distance over the trials for every subject and mass.

```{r missdistvartplot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Variance over trials.'}
plot_grid(miss_dist_vart[['pref']]+theme(legend.position = 'none'),
          miss_dist_vart[['smallt']]+theme(legend.position = 'none'),
          miss_dist_vart[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
          align = 'vh',
          labels = c('2a','2b','2c'))
```
...
all_exp_avg_plot('miss_dist_variance',prefdata,smalltdata,pilotdata,ylab = 'Miss Dist Variance Average')

```

This next plot (fig \@ref{fig:missdistvartplotmet}) shows the variance of miss distance over the trials for every subject, mass, and Speed.

```{r missdistvartplotmet, echo = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Variance over trials for metabolic experiment.'}
miss_dist_vart[['metabolic']]
```

```{r, echo = FALSE, warning = FALSE, message = FALSE}

variable = 'miss_dist_variance'
string = paste('
...
### Angular Miss Variance over trials
```{r, echo = FALSE, warning = FALSE, message = FALSE}
miss_ang_vart = list()
miss_ang_vart[['pref']] <- variability_trial_plot(prefdata,'missangle','plot')
miss_ang_vart[['smallt']] <- variability_trial_plot(smalltdata,'missangle','plot')
miss_ang_vart[['pilot']] <- variability_trial_plot(pilotdata,'missangle','plot')
miss_ang_vart[['metabolic']] <- variability_trial_plot(metdata,'missangle','plot')
```

Table \@ref{tab:missangvartrialtab} shows the average variance values for experiment 2a, 2b, and 2c. These are calculated from a 20 trial window variance, then averaged over all points.

```{r missangvartrialtab, echo = FALSE, warning = FALSE, message = FALSE}
tab = cbind(aggregate(missangle_variance ~ eff_mass,prefdata,mean)$missangle_variance,
            aggregate(missangle_variance ~ eff_mass,smalltdata,mean)$missangle_variance,
            aggregate(missangle_variance ~ eff_mass,pilotdata,mean)$missangle_variance)
# tab = formatC(tab,format = 'e', digits = 3)
rownames(tab) = unique(prefdata$eff_mass)
colnames(tab) = c('2a','2b','2c')
kable(tab, caption = 'Average Variance by mass and experiment.')
...
Table \@ref{tab:missangvartrialtabmet} shows the average variance values for experiment 1.

```{r missangvartrialtabmet, echo = FALSE, warning = FALSE, message = FALSE}

miss_dist_tab = table_func_nosd(metdata, 'missangle_variance')
kable(miss_dist_tab, caption = 'Average Endpoint Error Variance for the metabolic experiment')

```

This next plot (fig \@ref{fig:missangvartplot}) shows the variance of angular over the trials for every subject and mass.

```{r missangvartplot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Variance over trials.'}
plot_grid(miss_ang_vart[['pref']]+theme(legend.position = 'none'),
          miss_ang_vart[['smallt']]+theme(legend.position = 'none'),
          miss_ang_vart[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
          align = 'vh',
          labels = c('2a','2b','2c'))
```
...
all_exp_avg_plot('missangle_variance',prefdata,smalltdata,pilotdata,ylab = 'Miss Angle Variance Average')

```

This next plot (fig \@ref{fig:missangvartplotmet}) shows the variance of miss distance over the trials for every subject, mass, and Speed.

```{r missangvartplotmet, echo = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Variance over trials for metabolic experiment.'}
miss_dist_vart[['metabolic']]
```

```{r, echo = FALSE, warning = FALSE, message = FALSE}

variable = 'missangle_variance'
string = paste('
               pdata = cbind(aggregate(movedur ~ speed + eff_mass,metdata,mean),
               aggregate(movedur ~ speed + eff_mass,metdata,sd)$movedur/sqrt(8),
               aggregate(',variable,' ~ speed + eff_mass,metdata,mean)$',variable,',
...
### Radial Miss Variance over trials

```{r, echo = FALSE, warning = FALSE, message = FALSE}
miss_ang_vart = list()
miss_ang_vart[['pref']] <- variability_trial_plot(prefdata,'miss_rad','plot')
miss_ang_vart[['smallt']] <- variability_trial_plot(smalltdata,'miss_rad','plot')
miss_ang_vart[['pilot']] <- variability_trial_plot(pilotdata,'miss_rad','plot')
miss_ang_vart[['metabolic']] <- variability_trial_plot(metdata,'miss_rad','plot')
```

Table \@ref{tab:missradvartrialtab} shows the average variance values for experiment 2a, 2b, and 2c. These are calculated from a 20 trial window variance, then averaged over all points.

```{r missradvartrialtab, echo = FALSE, warning = FALSE, message = FALSE}
tab = cbind(aggregate(miss_rad_variance ~ eff_mass,prefdata,mean)$miss_rad_variance,
            aggregate(miss_rad_variance ~ eff_mass,smalltdata,mean)$miss_rad_variance,
            aggregate(miss_rad_variance ~ eff_mass,pilotdata,mean)$miss_rad_variance)
# tab = formatC(tab,format = 'e', digits = 3)
rownames(tab) = unique(prefdata$eff_mass)
colnames(tab) = c('2a','2b','2c')
kable(tab, caption = 'Average Variance by mass and experiment.')
...
Table \@ref{tab:missradvartrialtabmet} shows the average variance values for experiment 1.

```{r missradvartrialtabmet, echo = FALSE, warning = FALSE, message = FALSE}

miss_dist_tab = table_func_nosd(metdata, 'miss_rad_variance')
kable(miss_dist_tab, caption = 'Average Endpoint Error Variance for the metabolic experiment')

```

This next plot (fig \@ref{fig:missradvartplot}) shows the variance of radial miss distance over the trials for every subject and mass.

```{r missradvartplot, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Variance over trials.'}
plot_grid(miss_ang_vart[['pref']]+theme(legend.position = 'none'),
          miss_ang_vart[['smallt']]+theme(legend.position = 'none'),
          miss_ang_vart[['pilot']]+theme(legend.position = 'none'),
          nrow = 1,
...
all_exp_avg_plot('miss_rad_variance',prefdata,smalltdata,pilotdata,ylab = 'Miss Angle Variance Average')

```

This next plot (fig \@ref{fig:missradvartplotmet}) shows the variance of miss distance over the trials for every subject, mass, and Speed.

```{r missradvartplotmet, echo = FALSE, warning = FALSE, fig.width=14, fig.height=6, fig.cap = 'Miss Dist Variance over trials for metabolic experiment.'}
miss_dist_vart[['metabolic']]
```

```{r, echo = FALSE, warning = FALSE, message = FALSE}

variable = 'miss_rad_variance'
string = paste('
               pdata = cbind(aggregate(movedur ~ speed + eff_mass,metdata,mean),
               aggregate(movedur ~ speed + eff_mass,metdata,sd)$movedur/sqrt(8),
               aggregate(',variable,' ~ speed + eff_mass,metdata,mean)$',variable,',
