...
reaction_tanvel_nv[['pref']]<-avg_plot('reaction_tanvel',prefdata,ylab = 'Reaction Velocity (m/s)')+theme(legend.position = 'none')

reaction_tanvel_nv[['pilot']]<-avg_plot('reaction_tanvel',pilotdata,ylab = 'Reaction Velocity (m/s)')+theme(legend.position = 'none')

reaction_tanvel_nv[['smallt']]<-avg_plot('reaction_tanvel',smalltdata,ylab = 'Reaction Velocity (m/s)')+theme(legend.position = 'none')
```
