...
prefdata <- add_norm(prefdata,c('movedur','peakvel_target'))
smalltdata <- add_norm(smalltdata,c('movedur','peakvel_target'))
pilotdata <- add_norm(pilotdata,c('movedur','peakvel_target'))
...
# ```{r movedur_norm2, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration by experiment.'}
  # prefpilot$tempexp[prefpilot$exp=='smallt'] = 1
  # prefpilot$tempexp[prefpilot$exp=='pref'] = 2
  # prefpilot$tempexp[prefpilot$exp=='pilot'] = 3
...
resamp_plots = list()
resamp_plots[['pref']] <- resample_plot(resample_data_pref_abs,200)+
  theme(legend.position='none')+
  theme(text              = element_text(color='black'),
        axis.text         = element_text(color='black'),
        axis.ticks        = element_line(color='black'),
...
resamp_plots[['smallt']] <- resample_plot(resample_data_smallt_abs,200)+
  theme(legend.position='none')+
  theme(text              = element_text(color='black'),
        axis.text         = element_text(color='black'),
        axis.ticks        = element_line(color='black'),
