...
These next plots are made to try and show the effect of reaciton time algorithms on reaction. Figure \@ref{fig:reactiontanvalgoplot} shows the reaction time by experiment and algorithm. Figure \@ref{fig:reactiontanvelalgoplot} shows the velocity at reaction time by the experiments and algorithms. This plot shows that my algorithm is detecting movement onset at very very low movement speeds, whereas other methods detect it at MUCH higher movement speeds.

```{r reactiontanvalgoplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width=12, fig.height=5, fig.cap = 'Reaction Time Algorithm method.'}
...
plot_grid(reaction_tanv_algo[['pref']]+theme(legend.position = 'none')+scale_y_continuous(breaks = seq(.16,.32,.02), limits = c(.16,.32)),
          reaction_tanv_algo[['smallt']]+theme(legend.position = 'none')+scale_y_continuous(breaks = seq(.16,.32,.02), limits = c(.16,.32)),
          reaction_tanv_algo[['pilot']]+theme(legend.position = 'none')+scale_y_continuous(breaks = seq(.16,.32,.02), limits = c(.16,.32)),
...
```{r reactiontanvelalgoplot, echo = FALSE, warning = FALSE, message = FALSE, fig.width=12, fig.height=5, fig.cap = 'Reaction Velocity Algorithm method.'}
...
plot_grid(reaction_tanvel_algo[['pref']]+theme(legend.position = 'none')+scale_y_continuous(breaks = seq(0,.024,.004), limits = c(-.001,.024)),
          reaction_tanvel_algo[['smallt']]+theme(legend.position = 'none')+scale_y_continuous(breaks = seq(0,.024,.004), limits = c(-.001,.024)),
          reaction_tanvel_algo[['pilot']]+theme(legend.position = 'none')+scale_y_continuous(breaks = seq(0,.024,.004), limits = c(-.001,.024)),
