...
The plot below shows the fits of the glm's fitted to only data from experiment 2a and 2b. Unfortunately, these glm's don't seem to have the same behavior as data fitted to experiment 1. This is probably due to the lack of really fast or really slow trials so it just predicts a flat line essentially.

```{r p_alpha_2a_2b_glm_fig, echo=FALSE, warning = FALSE,  fig.width=8, fig.height=7, fig.cap = 'Probability of success with glm fitted to experiment 2a and 2b data.'}
