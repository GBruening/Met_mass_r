...
alpha_smallt=optimize(fun_optim_prx_comb,
                      masses     = masses,
                      mvttimes   = mvttimes_smallt,
...
alpha_smallt=optimize(fun_optim_prx_logit_comb,
                      masses     = masses,
                      mvttimes   = mvttimes_smallt,
                      glm1       = met_p_glm,
                      glm2       = smallt_p_glm,
...
alpha_pilot=optimize(fun_optim_prx_comb,
                     masses   = masses,
...
# c=coef(MPNet_model)[3]
# d=coef(MPNet_model)[4]
# util_dur_pilot_alpha_net = as.numeric(fun_optim_prx(alpha_pilot$minimum,
#                                        masses = masses,
#                                        mvttimes = mvttimes,
#                                        p_alpha  = c(1,1,1,1),
#                                        opt_or_dur = 'duration',
...
This table (@\ref(tab:utilcoefftabs2)) shows the duration from experiment 2a, along with the optimized predictions for each of the utility/effort models.

```{r utilcoefftabs2, echo = FALSE, warning = FALSE, message = FALSE}
...
model_durs = data.frame('eff_mass' = cbind(rep(masses,13)),
                        ...
                        'movedur' = c(aggregate(movedur~eff_mass,prefdata,mean)$movedur,
                                     ...
                                     util_dur_gross_rx,
                                     util_dur_net_rx,
                                     util_dur_pref_alpha_comb_gross,
                                     util_dur_pref_alpha_comb_net,
                                     m1_dur,
                                     m2_dur,
                                     torque_dur,
                                     prob_dur_pref),
