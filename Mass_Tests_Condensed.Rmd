...
```{r reactiontanvalgo1, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Reaction Time Algorithm method.'}
  plot_grid(reaction_tanv_algo[['pref']]+theme(legend.position = 'none'),
            reaction_tanv_algo[['smallt']]+theme(legend.position = 'none'),
            reaction_tanv_algo[['pilot']]+theme(legend.position = 'none'),
