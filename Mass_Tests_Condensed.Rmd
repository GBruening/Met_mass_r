...
This table (@\ref(tab:utildurs2a)) shows the duration from experiment 2a, along with the optimized predictions for each of the utility/effort models.
...
```{r alphavalues, echo = FALSE, warning = FALSE, message = FALSE, tab.cap = '$\alpha$ fits for the different experiements'}
