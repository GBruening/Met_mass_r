...
pref_p_glm  = glm(success ~ movedur+eff_mass,
                 data=prefdata,
...
smallt_p_glm  = glm(success ~ movedur+eff_mass,
                    data=smalltdata,
                    family=binomial(link="logit"))
...
tab = cbind(c(paste(round(coef(pref_p_glm)[1],4),'±',round(coef(summary(pref_p_glm))[1,2],3),sep=' '),
              paste(round(coef(pref_p_glm)[3],4),'±',round(coef(summary(pref_p_glm))[3,2],3),sep=' '),
...
# alpha_pref=optimize(fun_optim_prx_comb,
...
# USING logit function
alpha_pref=optimize(fun_optim_prx_logit_comb,
                      masses     = c(masses,masses),
                      mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                      glm1       = met_p_glm,
                      glm2       = smallt_p_glm,
...
c=coef(MPGross_model)[3]
d=coef(MPGross_model)[4]
util_dur_pref_alpha_comb_gross = as.numeric(fun_optim_prx_logit_comb(alpha_pref$minimum,
                                       masses     = c(masses,masses),
                                       mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                                       glm1       = met_p_glm,
                                       glm2       = smallt_p_glm,
...
c=coef(MPNet_model)[3]
d=coef(MPNet_model)[4]
util_dur_pref_alpha_comb_net = as.numeric(fun_optim_prx_logit_comb(alpha_pref$minimum,
                                       masses     = c(masses,masses),
                                       mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                                       glm1       = met_p_glm,
                                       glm2       = smallt_p_glm,
...
c=coef(MPGross_model)[3]
d=coef(MPGross_model)[4]
util_dur_pilot_alpha_gross = as.numeric(fun_optim_prx_comb(alpha_pilot$minimum,
                                       masses = masses,
                                       mvttimes = mvttimes,
                                       p_alpha  = c(1,1,1,1),
                                       opt_or_dur = 'duration',
...
control_times = rbind(cbind(rep('smallt',4),rep('data',4),c(2.5,3.8,4.7,6.1),mvttimes_smallt,rep(3,4),mvttimes_smallt_se),
                      ...
                      cbind(rep('pref',4),rep('model',4),c(2.5,3.8,4.7,6.1),util_dur_gross,rep(1,4),rep(0,4)),
