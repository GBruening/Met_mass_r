...
# count = 1
# for (t in times){
#   ut1000[count] = (alpha*probs[count]-a0*rt-(a*t+b*(m^c)/(t^(d-1))))/(rt+t)
#   count = count+1
# }
...
# count = 1
# for (t in times){
#   ut5000[count] = (alpha2*probs[count]-a0*rt-(a*t+b*(m^c)/(t^(d-1))))/(rt+t)
#   count = count+1
# }
...
#                                rep(alpha,length(times)),
#                                rep(alpha2,length(times))),
#                              c(times,times,times),
...
#   scale_x_continuous(expand = c(0, 0), limits = c(.4, 1.20))+
