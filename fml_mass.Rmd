...
pilotdata[pilotdata$trialtot<101,'condition'] = 'fml'

smalltdata = filter(smalltdata,trial<200)

fml_plot <- function(data, variable, labels, group_meth){
  data$variable = data[,variable]
  
  if (group_meth == 'Subject'){
    g <- ggplot()+
  ...
  } else if (group_meth == 'Condition'){
    g <- ggplot()+
      geom_smooth(data=prefdata,
                  aes(x = trial,
                      y = movedur,
...
fml_plot_delc <- function(data, variable, labels, group_meth){
  data$variable = data[,variable]
    ...
    g <- ggplot()+
      geom_smooth(data=data,
                  aes(x = trial,
                      ...
                      color = factor(subj)),
                  method = 'loess')+
      facet_wrap(~factor(delcond))
  } else if (group_meth == 'Condition'){
    g <- ggplot()+
      geom_smooth(data=prefdata,
                  aes(x = trial,
                      y = movedur,
                      color = factor(delcond)),
                  method = 'loess')+
...
variable = 'movedur'
labels = list()
labels['title'] = 'Preferred Experiment'
labels['ylab'] = 'Movement Duration (s)'
labels['xlab'] = 'Trial #'
```

```{r, fig.width=9, fig.height=6}

labels['title'] = 'Circle Target Experiment'
fml_plot(prefdata,variable,labels,'Subject')

```

```{r, fig.width=9, fig.height=6}

labels['title'] = 'Smallt Target Experiment'
fml_plot(smalltdata,variable,labels,'Subject')

```

```{r, fig.width=9, fig.height=6}

labels['title'] = 'No Target Experiment'
fml_plot(pilotdata,variable,labels,'Subject')
...
labels['title'] = 'Circle Target Experiment'
fml_plot(prefdata,variable,labels,'Condition')
...
labels['title'] = 'Smallt Target Experiment'
fml_plot(smalltdata,variable,labels,'Condition')
...
labels['title'] = 'No Target Experiment'
fml_plot(pilotdata,variable,labels,'Condition')
...
### Split by subj
```{r, echo = FALSE}
variable = 'peakvel_target'
labels['ylab'] = 'Peak Velocity (m/s)'
```
...
labels['title'] = 'Circle Target Experiment'
fml_plot_delc(prefdata,variable,labels,'Subject')
...
labels['title'] = 'Smallt Target Experiment'
fml_plot_delc(smalltdata,variable,labels,'Subject')
...
labels['title'] = 'No Target Experiment'
fml_plot_delc(pilotdata,variable,labels,'Subject')
...
labels['title'] = 'Circle Target Experiment'
fml_plot_delc(prefdata,variable,labels,'Condition')

eval(parse(text = paste('cftest(lmer(',variable,' ~ delcond + trial +(1|subj),data=prefdata))')))
...
labels['title'] = 'Smallt Target Experiment'
fml_plot_delc(smalltdata,variable,labels,'Condition')

eval(parse(text = paste('cftest(lmer(',variable,' ~ delcond + trial +(1|subj),data=smalltdata))')))
...
labels['title'] = 'No Target Experiment'
fml_plot_delc(pilotdata,variable,labels,'Condition')

eval(parse(text = paste('cftest(lmer(',variable,' ~ delcond + trial +(1|subj),data=pilotdata))')))
...
### Split by subj
```{r, echo = FALSE}
variable = 'movedur_norm'
labels = list()
labels['title'] = 'Preferred Experiment'
labels['ylab'] = 'Normalized Movement Duration (s)'
labels['xlab'] = 'Trial #'
```
...
### Split by subj
```{r, echo = FALSE}
variable = 'peakvel_target_norm'
labels['ylab'] = 'Normalized Peak Velocity (m/s)'
```
