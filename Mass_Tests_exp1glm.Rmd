...
```{r altutilitymodelsdiff, echo = FALSE, warning = FALSE, fig.height=10, fig.width = 10, fig.cap = 'Alternative utility model difference from experimental for 2a, 2b, and 2c.'}
