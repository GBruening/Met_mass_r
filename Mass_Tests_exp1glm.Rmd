...
Movedur_norm_by_experiment <- all_exp_avg_plot('movedur_norm',prefdata,smalltdata,pilotdata,ylab = 'Peak Velocity Normalized (m/s)')
...
Peakvel_norm_by_experiment <- all_exp_avg_plot('peakvel_norm',prefdata,smalltdata,pilotdata,ylab = 'Peak Velocity Normalized (m/s)')
...
Reacttime_norm_by_experiment <- all_exp_avg_plot('reaction_tanv_norm',prefdata,smalltdata,pilotdata,ylab = 'Reaction Time (s)')
...
plot_grid(Movedur_by_experiment,Peakvel_by_experiment,Reacttime_by_experiment,
          Movedurnorm_by_experiment,Peakvel_norm_by_experiment,Reacttime_norm_by_experiment)
```
