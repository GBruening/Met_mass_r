...
MCGross <- ggplot(data=mpdata_factor)+
  stat_function(aes(x=movedur),
                fun=fun.1,size=met_line_size,color='black')+
  stat_function(aes(x=movedur),
                fun=fun.2,size=met_line_size,color='black')+
  stat_function(aes(x=movedur),
                fun=fun.3,size=met_line_size,color='black')+
  stat_function(aes(x=movedur),
                fun=fun.4,size=met_line_size,color='black')+
  stat_function(aes(x=movedur),
