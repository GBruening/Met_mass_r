...
vars = c('targetnum','movedur','movedur_norm',
         'peakvel_target','peakvel_target_norm',
...
Reactvel_by_experiment <- all_exp_avg_plot('reaction_tanvel',prefdata,smalltdata,pilotdata,ylab = 'Reaction Velocity (s)')
...
movedur_nv = list()
movedur_nv[['pref']]<-avg_plot('movedur',prefdata,ylab = 'Movement duration (s)',shape = 21)+theme(legend.position = 'none')
movedur_nv[['pilot']]<-avg_plot('movedur',pilotdata,ylab = 'Movement duration (s)',shape = 22)+theme(legend.position = 'none')
movedur_nv[['smallt']]<-avg_plot('movedur',smalltdata,ylab = 'Movement duration (s)',shape = 24)+theme(legend.position = 'none')

```

```{r movedur1, echo = FALSE, warning = FALSE, fig.width=12, fig.height=12, fig.cap = 'Movement duration broken up by experiment.'}
...
```{r movedur_norm_exp_stat, echo = FALSE, warning = FALSE}
  # prefpilot$tempexp[prefpilot$exp=='smallt'] = 1
  # prefpilot$tempexp[prefpilot$exp=='pref'] = 2
  # prefpilot$tempexp[prefpilot$exp=='pilot'] = 3
  cftest(lmer(movedur_norm ~ factor(targetnum) + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
  # mass_exp_int_test = cftest(lmer(movedur_norm ~ factor(targetnum) + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
  
  # temp = aov(lm(movedur_norm ~ eff_mass*factor(exp) + (1|subj),data=prefpilot))
  # test2 =TukeyHSD(temp , which = 'exp')
  # plot(test2)
...
Movedur_norm_by_experiment <- all_exp_avg_plot('movedur_norm',prefdata,smalltdata,pilotdata,ylab = 'Movement Duration Normalized (s)')
...
movedur_norm[['pref']]<-vplot('movedur_norm',prefdata)+
  labs(x='Effective Mass (kg)',y='Movement Duration (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(prefdata,condition==0)$movedur_norm),linetype='dashed',size=.5)

movedur_norm[['pilot']]<-vplot('movedur_norm',pilotdata)+
  labs(x='Effective Mass (kg)',y='Movement Duration (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(pilotdata,condition==0)$movedur_norm),linetype='dashed',size=.5)


movedur_norm[['smallt']]<-vplot('movedur_norm',smalltdata)+
  labs(x='Effective Mass (kg)',y='Movement Duration (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(smalltdata,condition==0)$movedur_norm),linetype='dashed',size=.5)

movedur_norm_nv = list()
movedur_norm_nv[['pref']]<-avg_plot('movedur_norm',prefdata,ylab = 'Movement duration (s)',shape = 21)+theme(legend.position = 'none')
movedur_norm_nv[['pilot']]<-avg_plot('movedur_norm',pilotdata,ylab = 'Movement duration (s)',shape = 22)+theme(legend.position = 'none')
movedur_norm_nv[['smallt']]<-avg_plot('movedur_norm',smalltdata,ylab = 'Movement duration (s)',shape = 24)+theme(legend.position = 'none')

```

```{r movedur_norm1, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration broken up by experiment.'}
  plot_grid(movedur_norm[['pref']],
            movedur_norm[['smallt']],
            movedur_norm[['pilot']],
            movedur_norm_nv[['pref']],
            movedur_norm_nv[['smallt']],
            movedur_norm_nv[['pilot']],
            nrow = 2,
            align = 'vh',
            labels = c('Preferred','Smallt','2c','','',''))
```
...
peakvel_target_nv[['pref']]<-avg_plot('peakvel_target',prefdata,ylab = 'Peak Velocity (m/s)',shape = 21)+theme(legend.position = 'none')
peakvel_target_nv[['pilot']]<-avg_plot('peakvel_target',pilotdata,ylab = 'Peak Radial Velocity (m/s)',shape = 22)+theme(legend.position = 'none')
peakvel_target_nv[['smallt']]<-avg_plot('peakvel_target',smalltdata,ylab = 'Peak Velocity (m/s)',shape = 24)+theme(legend.position = 'none')
...
This next stat output shows the a LME with movedur ~ target + eff_mass*exp + (1|subj).
```{r peakvel_norm_exp_stat, echo = FALSE, warning = FALSE}
# ```{r movedur2, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration by experiment.'}
  cftest(lmer(peakvel_target_norm ~ factor(targetnum) + eff_mass + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
```
...
Peakvel_norm_by_experiment <- all_exp_avg_plot('peakvel_target_norm',prefdata,smalltdata,pilotdata,ylab = 'Peak Velocity Normalized (m/s)')
...
```{r, echo = FALSE, warning = FALSE}
peakvel_target_norm = list()
peakvel_target_norm[['pref']]<-vplot('peakvel_target_norm',prefdata)+
  labs(x='Effective Mass (kg)',y='Peak Velocity (m/s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')

peakvel_target_norm[['pilot']]<-vplot('peakvel_radv',pilotdata)+
  labs(x='Effective Mass (kg)',y='Peak Radial Velocity (m/s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')
...
peakvel_target_norm[['smallt']]<-vplot('peakvel_target_norm',smalltdata)+
  labs(x='Effective Mass (kg)',y='Peak Velocity (m/s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')
...
peakvel_target_norm_nv = list()
peakvel_target_norm_nv[['pref']]<-avg_plot('peakvel_target_norm',prefdata,ylab = 'Peak Velocity (m/s)',shape = 21)+theme(legend.position = 'none')

peakvel_target_norm_nv[['pilot']]<-avg_plot('peakvel_target_norm',pilotdata,ylab = 'Peak Radial Velocity (m/s)',shape = 22)+theme(legend.position = 'none')

peakvel_target_norm_nv[['smallt']]<-avg_plot('peakvel_target_norm',smalltdata,ylab = 'Peak Velocity (m/s)',shape = 24)+theme(legend.position = 'none')

```

```{r peakvelnorm, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Peak velocity broken by experiment.'}
  plot_grid(peakvel_target_norm[['pref']],
            peakvel_target_norm[['smallt']],
            peakvel_target_norm[['pilot']],
            peakvel_target_norm_nv[['pref']],
            peakvel_target_norm_nv[['smallt']],
            peakvel_target_norm_nv[['pilot']],
            nrow = 2,
            align = 'vh',
            labels = c('Preferred','Smallt','2c','','',''))
```
...
reaction_tanv_nv[['pref']]<-avg_plot('reaction_tanv',prefdata,ylab = 'Reaction Time (s)',shape = 21)+theme(legend.position = 'none')
reaction_tanv_nv[['pilot']]<-avg_plot('reaction_tanv',pilotdata,ylab = 'Reaction Time (s)',shape = 22)+theme(legend.position = 'none')
reaction_tanv_nv[['smallt']]<-avg_plot('reaction_tanv',smalltdata,ylab = 'Reaction Time (s)',shape = 24)+theme(legend.position = 'none')

reaction_tanv_norm_nv = list()
reaction_tanv_norm_nv[['pref']]<-avg_plot('reaction_tanv_norm',prefdata,ylab = 'Reaction Time Norm (s)',shape = 21)+theme(legend.position = 'none')
reaction_tanv_norm_nv[['pilot']]<-avg_plot('reaction_tanv_norm',pilotdata,ylab = 'Reaction Time Norm (s)',shape = 22)+theme(legend.position = 'none')
reaction_tanv_norm_nv[['smallt']]<-avg_plot('reaction_tanv_norm',smalltdata,ylab = 'Reaction Time Norm (s)',shape = 24)+theme(legend.position = 'none')
```
...
This next stat output shows the a LME with movedur ~ target + eff_mass*exp + (1|subj).
```{r reactiontanvnorm_exp_stat, echo = FALSE, warning = FALSE}
# ```{r movedur2, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration by experiment.'}
cftest(lmer(reaction_tanv_norm ~ factor(targetnum) + eff_mass + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
```
...
Reacttime_norm_by_experiment <- all_exp_avg_plot('reaction_tanv_norm',prefdata,smalltdata,pilotdata,ylab = 'Reaction Time Normalized (s)')

Reacttime_norm_by_experiment+theme(text = element_text(size = 18))
```

```{r, echo = FALSE, warning = FALSE}
reaction_tanv_norm = list()
reaction_tanv_norm[['pref']]<-vplot('reaction_tanv_norm',prefdata)+
  labs(x='Effective Mass (kg)',y='Reaction Time (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(prefdata,condition==0)$reaction_tanv_norm),linetype='dashed',size=.5)

reaction_tanv_norm[['pilot']]<-vplot('reaction_tanv_norm',pilotdata)+
  labs(x='Effective Mass (kg)',y='Reaction Time (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(pilotdata,condition==0)$reaction_tanv_norm),linetype='dashed',size=.5)

reaction_tanv_norm[['smallt']]<-vplot('reaction_tanv_norm',smalltdata)+
  labs(x='Effective Mass (kg)',y='Reaction Time (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(smalltdata,condition==0)$reaction_tanv_norm),linetype='dashed',size=.5)


reaction_tanv_norm_nv = list()
reaction_tanv_norm_nv[['pref']]<-avg_plot('reaction_tanv_norm',prefdata,ylab = 'Reaction Time (s)',shape = 21)+theme(legend.position = 'none')
reaction_tanv_norm_nv[['pilot']]<-avg_plot('reaction_tanv_norm',pilotdata,ylab = 'Reaction Time (s)',shape = 22)+theme(legend.position = 'none')
reaction_tanv_norm_nv[['smallt']]<-avg_plot('reaction_tanv_norm',smalltdata,ylab = 'Reaction Time (s)',shape = 24)+theme(legend.position = 'none')
```

```{r reactiontanvnorm, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Reaction Time broken by experiment.'}
plot_grid(reaction_tanv_norm[['pref']],
          reaction_tanv_norm[['smallt']],
          reaction_tanv_norm[['pilot']],
          reaction_tanv_norm_nv[['pref']],
          reaction_tanv_norm_nv[['smallt']],
          reaction_tanv_norm_nv[['pilot']],
          nrow = 2,
          align = 'vh',
          labels = c('Preferred','Smallt','2c','','',''))
```
...
kable(reactvel, caption = 'Reaction velocity average values (m/s)')

```

This next stat output shows the a LME with movedur ~ target + eff_mass*exp + (1|subj).
```{r reactiontanvelexpstat, echo = FALSE, warning = FALSE}
# ```{r movedur2, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration by experiment.'}
cftest(lmer(reaction_tanvel ~ factor(targetnum) + eff_mass + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
```
...
```{r, echo = FALSE, warning = FALSE}
reaction_tanvel = list()
reaction_tanvel[['pref']]<-vplot('reaction_tanvel',prefdata)+
  labs(x='Effective Mass (kg)',y='Reaction Velocity (m/s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(prefdata,condition==0)$reaction_tanvel),linetype='dashed',size=.5)

reaction_tanvel[['pilot']]<-vplot('reaction_tanvel',pilotdata)+
  labs(x='Effective Mass (kg)',y='Reaction Velocity (m/s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(pilotdata,condition==0)$reaction_tanvel),linetype='dashed',size=.5)

reaction_tanvel[['smallt']]<-vplot('reaction_tanvel',smalltdata)+
  labs(x='Effective Mass (kg)',y='Reaction Velocity (m/s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(smalltdata,condition==0)$reaction_tanvel),linetype='dashed',size=.5)


reaction_tanvel_nv = list()
reaction_tanvel_nv[['pref']]<-avg_plot('reaction_tanvel',prefdata,ylab = 'Reaction Velocity (m/s)',shape = 21)+theme(legend.position = 'none')
reaction_tanvel_nv[['pilot']]<-avg_plot('reaction_tanvel',pilotdata,ylab = 'Reaction Velocity (m/s)',shape = 22)+theme(legend.position = 'none')
reaction_tanvel_nv[['smallt']]<-avg_plot('reaction_tanvel',smalltdata,ylab = 'Reaction Velocity (m/s)',shape = 24)+theme(legend.position = 'none')
```

```{r reactiontanvel1, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Reaction  broken by experiment.'}
plot_grid(reaction_tanvel[['pref']],
          reaction_tanvel[['smallt']],
          reaction_tanvel[['pilot']],
          reaction_tanvel_nv[['pref']],
          reaction_tanvel_nv[['smallt']],
          reaction_tanvel_nv[['pilot']],
          nrow = 2,
          align = 'vh',
          labels = c('Preferred','Smallt','2c','','',''))
```
...
This next stat output shows the a LME with movedur ~ target + eff_mass*exp + (1|subj).
```{r reactiontanvpercstat, echo = FALSE, warning = FALSE}
# ```{r movedur2, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration by experiment.'}
cftest(lmer(reaction_tanv_perc ~ factor(targetnum) + eff_mass + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
```
...
Reacttime_perc_by_experiment <- all_exp_avg_plot('reaction_tanv_perc',prefdata,smalltdata,pilotdata,ylab = 'Reaction Time Perc (% of Movedur)')
Reacttime_perc_by_experiment+theme(text = element_text(size = 18))
```

```{r, echo = FALSE, warning = FALSE}
reaction_tanv_perc = list()
reaction_tanv_perc[['pref']]<-vplot('reaction_tanv_perc',prefdata)+
  labs(x='Effective Mass (kg)',y='Reaction Time % (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(prefdata,condition==0)$reaction_tanv_perc),linetype='dashed',size=.5)

reaction_tanv_perc[['pilot']]<-vplot('reaction_tanv_perc',pilotdata)+
  labs(x='Effective Mass (kg)',y='Reaction Time %  (s)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(pilotdata,condition==0)$reaction_tanv_perc),linetype='dashed',size=.5)

reaction_tanv_perc[['smallt']]<-vplot('reaction_tanv_perc',smalltdata)+
  labs(x='Effective Mass (kg)',y='Reaction Time (s)')+
  guides(fill=guide_legend(title="Effective\nMass % (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(smalltdata,condition==0)$reaction_tanv_perc),linetype='dashed',size=.5)


reaction_tanv_perc_nv = list()
reaction_tanv_perc_nv[['pref']]<-avg_plot('reaction_tanv_perc',prefdata,ylab = 'Reaction Time % (s)',shape = 21)+theme(legend.position = 'none')
reaction_tanv_perc_nv[['pilot']]<-avg_plot('reaction_tanv_perc',pilotdata,ylab = 'Reaction Time % (s)',shape = 22)+theme(legend.position = 'none')
reaction_tanv_perc_nv[['smallt']]<-avg_plot('reaction_tanv_perc',smalltdata,ylab = 'Reaction Time % (s)',shape = 24)+theme(legend.position = 'none')

# reaction_tanv_perc_norm_nv = list()
# reaction_tanv_perc_norm_nv[['pref']]<-avg_plot('reaction_tanv_perc_norm',prefdata,ylab = 'Reaction Time % Norm (s)',shape = 21)+theme(legend.position = 'none')
# reaction_tanv_perc_norm_nv[['pilot']]<-avg_plot('reaction_tanv_perc_norm',pilotdata,ylab = 'Reaction Time % Norm (s)',shape = 22)+theme(legend.position = 'none')
# reaction_tanv_perc_norm_nv[['smallt']]<-avg_plot('reaction_tanv_perc_norm',smalltdata,ylab = 'Reaction Time % Norm (s)',shape = 24)+theme(legend.position = 'none')
```

```{r reactiontanvperc, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Reaction Time broken by experiment.'}
plot_grid(reaction_tanv_perc[['pref']],
          reaction_tanv_perc[['smallt']],
          reaction_tanv_perc[['pilot']],
          reaction_tanv_perc_nv[['pref']],
          reaction_tanv_perc_nv[['smallt']],
          reaction_tanv_perc_nv[['pilot']],
          nrow = 2,
          align = 'vh',
          labels = c('Preferred','Smallt','2c','','',''))
```
...
miss_dist_by_experiment <- all_exp_avg_plot('miss_dist',
                                            prefdata,
                                            smalltdata,
                                            pilotdata,
...
Miss_dist_norm_by_experiment <- all_exp_avg_plot('miss_dist_norm',prefdata,smalltdata,pilotdata,ylab = 'Miss Distance Normalized (m/s)')
...
miss_dist_nv = list()
miss_dist_nv[['pref']]<-avg_plot('miss_dist',prefdata,ylab = 'Miss Distance (cm)',shape = 21)+theme(legend.position = 'none')
miss_dist_nv[['pilot']]<-avg_plot('miss_dist',pilotdata,ylab = 'Maximum Excursion (cm)',shape = 22)+theme(legend.position = 'none')
miss_dist_nv[['smallt']]<-avg_plot('miss_dist',smalltdata,ylab = 'Miss Distance (cm)',shape = 24)+theme(legend.position = 'none')
...
kable(miss_dist_norm_time, caption = 'Miss Distance Norm average values (cm)')

```

This next stat output shows the a LME with miss_dist_norm ~ target + eff_mass*exp + (1|subj).
```{r missdistexpstatnorm, echo = FALSE, warning = FALSE}
# ```{r movedur2, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Movement duration by experiment.'}
cftest(lmer(miss_dist_norm ~ factor(targetnum) + eff_mass + eff_mass*factor(exp) +  (1|subj),data=prefpilot))
```
...
```{r, echo = FALSE, warning = FALSE}
prefdata$miss_dist_norm = prefdata$miss_dist_norm*100
pilotdata$miss_dist_norm = pilotdata$miss_dist_norm*100
smalltdata$miss_dist_norm = smalltdata$miss_dist_norm*100

miss_dist_norm = list()
miss_dist_norm[['pref']]<-vplot('miss_dist_norm',prefdata)+
  labs(x='Effective Mass (kg)',y='Miss Distance Norm (cm)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(prefdata,condition==0)$miss_dist_norm),linetype='dashed',size=.5)

miss_dist_norm[['pilot']]<-vplot('miss_dist_norm',pilotdata)+
  labs(x = 'Effective Mass (kg)',y = 'Maximum Excursion (cm)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(pilotdata,condition==0)$miss_dist_norm),linetype='dashed',size=.5)

miss_dist_norm[['smallt']]<-vplot('miss_dist_norm',smalltdata)+
  labs(x='Effective Mass (kg)',y='Miss Distance Norm (cm)')+
  guides(fill=guide_legend(title="Effective\nMass (kg)"))+
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(smalltdata,condition==0)$miss_dist_norm),linetype='dashed',size=.5)


miss_dist_norm_nv = list()
miss_dist_norm_nv[['pref']]<-avg_plot('miss_dist_norm',prefdata,ylab = 'Miss Distance Norm (cm)',shape = 21)+theme(legend.position = 'none')
miss_dist_norm_nv[['pilot']]<-avg_plot('miss_dist_norm',pilotdata,ylab = 'Maximum Excursion (cm)',shape = 22)+theme(legend.position = 'none')
miss_dist_norm_nv[['smallt']]<-avg_plot('miss_dist_norm',smalltdata,ylab = 'Miss Distance Norm (cm)',shape = 24)+theme(legend.position = 'none')
...
```{r miss_dist_norm11, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Miss Distance Norm (cm) broken by experiment.'}
plot_grid(miss_dist_norm[['pref']],
          miss_dist_norm[['smallt']],
          miss_dist_norm[['pilot']],
          miss_dist_norm_nv[['pref']],
          miss_dist_norm_nv[['smallt']],
          miss_dist_norm_nv[['pilot']],
          nrow = 2,
          align = 'vh',
          labels = c('2a','2b','2c','','',''))
```
...
missangle[['pref']]<-vplot('missangle',filter(var_data,exp=='pref'))+
  ...
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(filter(var_data,exp=='pref'),eff_mass==2.506)$missangle),linetype='dashed',size=.5)
...
missangle[['pilot']]<-vplot('missangle',filter(var_data,exp=='pilot'))+
  ...
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(filter(var_data,exp=='pilot'),eff_mass==2.506)$missangle),linetype='dashed',size=.5)
...
missangle[['smallt']]<-vplot('missangle',filter(var_data,exp=='smallt'))+
  ...
  # theme_classic()
  theme(legend.position='none')+
  geom_hline(yintercept=mean(filter(filter(var_data,exp=='smallt'),eff_mass==2.506)$missangle),linetype='dashed',size=.5)


missangle_nv = list()
missangle_nv[['pref']]<-avg_plot('missangle',filter(var_data,exp=='pref'),ylab = 'Miss Angle Variance (deg^2)',shape = 21)+theme(legend.position = 'none')
missangle_nv[['pilot']]<-avg_plot('missangle',filter(var_data,exp=='pilot'),ylab = 'Miss Angle Variance (deg^2)',shape = 22)+theme(legend.position = 'none')
missangle_nv[['smallt']]<-avg_plot('missangle',filter(var_data,exp=='smallt'),ylab = 'Miss Angle Variance (deg^2)',shape = 24)+theme(legend.position = 'none')

missangle_norm_nv = list()
missangle_norm_nv[['pref']]<-avg_plot('missangle_norm',filter(var_data,exp=='pref'),ylab = 'Miss Angle Variance Norm (deg^2)',shape = 21)+theme(legend.position = 'none')
missangle_norm_nv[['pilot']]<-avg_plot('missangle_norm',filter(var_data,exp=='pilot'),ylab = 'Miss Angle Variance Norm (deg^2)',shape = 22)+theme(legend.position = 'none')
missangle_norm_nv[['smallt']]<-avg_plot('missangle_norm',filter(var_data,exp=='smallt'),ylab = 'Miss Angle Variance Norm (deg^2)',shape = 24)+theme(legend.position = 'none')
...
## Probability of success LME
```{r,echo=FALSE}

prob_data = rbind(cbind(aggregate(success ~ eff_mass + subj, prefdata,mean),'pref') %>% `colnames<-`(c('eff_mass','subj','success','exp')),
                  cbind(aggregate(success ~ eff_mass + subj, smalltdata,mean),'pref') %>% `colnames<-`(c('eff_mass','subj','success','exp')))

cftest(lmer(success ~ eff_mass + (1|subj), data=prob_data))

all_exp_avg_plot('success',prefdata,smalltdata,smalltdata,ylab = 'Success Probabolity')
```
...
resamp_plots[['pilot']] <- resample_plot(resample_data_pilot_abs,250)+
...
exp_plots_norm = list()
for (exp in c('pref','pilot','smallt')){
  exp_plots_norm[[exp]] = plot_grid(resamp_plots[[exp]],
                               movedur_norm[[exp]],
                               peakvel_target_norm[[exp]],
                               reaction_tanv_norm[[exp]],
                               nrow = 1,
                               rel_widths = c(2,1,1,1))
}
add_legend = get_legend(movedur_norm[['pref']]+theme(legend.position = 'right'))
pref_results_norm = plot_grid(plot_grid(NULL,
                                   exp_plots_norm[['pref']],
                                   NULL,
                                   exp_plots_norm[['smallt']],
                                   NULL,
                                   exp_plots_norm[['pilot']],
                                   nrow = 6,
                                   labels = c('2a','','2b','','2c'),
                                   # labels = 'AUTO',
                                   rel_heights = c(.15,1,.15,1,.15,1)),
...
setwd(pref_plots_dir)
if (save_plots){
  ggsave('Pref_results_norm_r2.pdf',plot=pref_results_norm,width=9/.9,height=9, useDingbats = FALSE)
}
```

```{r prefresultsnorm, echo = FALSE, warning = FALSE, fig.width=12, fig.height=9, fig.cap = 'Preferred experiment Norm results.'}
pref_results_norm
```

```{r prefresults_norm_nv, echo = FALSE, warning = FALSE, message = FALSE}
# This is only for the non-violin plot versions.
exp_plots_norm_nv = list()
for (exp in c('pref','pilot','smallt')){
  data <- eval(parse(text = paste(exp,'data',sep='')))
  exp_plots_norm_nv[[exp]] = plot_grid(resamp_plots[[exp]],
                                  movedur_norm_nv[[exp]],
                                  peakvel_target_norm_nv[[exp]],
                                  reaction_tanv_norm_nv[[exp]],
                                  miss_dist_norm_nv[[exp]],
                                  missangle_norm_nv[[exp]],
                                  miss_rad_norm_nv[[exp]],
                                  nrow = 1,
                                  rel_widths = c(2,1,1,1,1,1,1))
}

add_legend = get_legend(movedur_norm[['pref']]+theme(legend.position = 'right'))
pref_results_norm_nv = plot_grid(plot_grid(NULL,
                                      exp_plots_norm_nv[['pref']],
                                      NULL,
                                      exp_plots_norm_nv[['smallt']],
                                      NULL,
                                      exp_plots_norm_nv[['pilot']],
                                      nrow = 6,
                                      labels = c('2a','','2b','','2c'),
                                      # labels = 'AUTO',
                                      rel_heights = c(.15,1,.15,1,.15,1)),
...
setwd(pref_plots_dir)
if (save_plots){
  ggsave('Pref_results_norm_nv.pdf',plot=pref_results_norm_nv,width=18/.9,height=9, useDingbats = FALSE)
}
```
...
fun.1 <- function(t) a_mpnet+b_mpnet*(2.44^c_mpnet)/(t^d_mpnet)
...
fun.1 <- function(t) a_mpgross*t+b_mpgross*(2.44^c_mpgross)/(t^(d_mpgross-1))
...
```{r, echo = FALSE, warning=FALSE}
fun.1 <- function(t) a_mpnet*t+b_mpnet*(2.44^c_mpnet)/(t^(d_mpnet-1))
...
preffun.1 <- function(t) a_mpnet*t+b_mpnet*(2.44^c_mpnet)/(t^(d_mpnet-1))
...
miss_dist_grouped_met <- ggplot()+
  ...
  geom_errorbar(data = pdata,
                aes(x=movedur,
                    ymin=yvar-yvarse-.002,
                    ymax=yvar+yvarse+.002),
                color = 'black',
                width = 0,
                size = met_errorbar_size+.5)+
  geom_errorbarh(data=pdata,
...
setwd(met_plots_dir)
if (save_plots){ggsave('Met_results_r.pdf',plot=met_results,width=8/.85,height=9, device=cairo_pdf)}
```
...
fun.1 <- function(t) b_torque_mj*(2.44^c_torque_mj)/(t^(d_torque_mj))
...
rownames(movedur_probs) = c('2.44','3.80','4.70','6.10','Mean')
...
pref_tab = cbind(c('2.44','3.8','4.7','6.1'),prob_dur_pref,round(mvttimes_pref,3))
...
smallt_tab = cbind(c('2.44','3.8','4.7','6.1'),prob_dur_smallt,round(mvttimes_smallt,3))
...
util_dur_gross_rx = as.numeric(fun_optim_prx_logit(
                                       ...
                                       opt_or_dur = 'duration',
                                       rxtimes    = rxtimes_pref))
ut1_alpha_2a = alpha_utility_gross_rx
ut1_dur_2a   = util_dur_gross_rx
...
util_dur_net_rx = as.numeric(fun_optim_prx_logit(alpha_utility_net_rx$minimum,
                                        ...
                                        opt_or_dur = 'duration',
                                        rxtimes = rxtimes_pref))
# ut1_alpha_2a = alpha_utility_net_rx
# ut1_dur_2a   = util_dur_net_rx
...
ut1_alpha_2b = alpha_smallt_gross
ut1_dur_2b   = util_dur_smallt_gross
...
ut1_alpha_2c = alpha_pilot_gross
ut1_dur_2c   = util_dur_pilot_gross
...
# Using logit function
ut2_alpha_2a = optimize(fun_optim_prx_logit_ut2,
                      masses     = masses,
                      mvttimes   = mvttimes_pref,
                      p_alpha    = pref_glm_use,
                      rxtimes    = rxtimes_pref,
...
ut2_dur_2a = as.numeric(fun_optim_prx_logit_ut2(
                         alpha      = ut2_alpha_2a$minimum,
                         masses     = masses,
                         mvttimes   = mvttimes_pref,
                         p_alpha    = pref_glm_use,
                         opt_or_dur = 'duration',
...
ut2_alpha_2b = optimize(fun_optim_prx_logit_ut2,
                      masses     = masses,
                      mvttimes   = mvttimes_smallt,
                      p_alpha    = smallt_glm_use,
                      rxtimes    = rxtimes_smallt,
...
ut2_dur_2b = as.numeric(fun_optim_prx_logit_ut2(
                           alpha = ut2_alpha_2b$minimum, #changing between alpha_pref and alpha_smallt_gross
                           masses   = masses,
                           mvttimes = mvttimes_smallt,
                           p_alpha  = smallt_glm_use,
                           rxtimes  = rxtimes_smallt,
...
ut2_alpha_2c = optimize(fun_optim_prx_ut2,
                     masses   = masses,
                     mvttimes = mvttimes_pilot,
                     p_alpha  = p_alpha_pilot_gross,
                     rxtimes  = rxtimes_pilot,
...
ut2_dur_2c = as.numeric(fun_optim_prx_ut2(
                          alpha = ut2_alpha_2c$minimum,
                          masses   = masses,
                          mvttimes = mvttimes_pilot,
                          p_alpha  = p_alpha_pilot_gross,
                          rxtimes  = rxtimes_pilot,
...
# Using logit function
ut3_alpha_2a = optimize(fun_optim_prx_logit_ut3,
                      masses     = masses,
                      mvttimes   = mvttimes_pref,
                      p_alpha    = pref_glm_use,
                      rxtimes    = rxtimes_pref,
...
ut3_dur_2a = as.numeric(fun_optim_prx_logit_ut3(
                         alpha      = ut3_alpha_2a$minimum,
                         masses     = masses,
                         mvttimes   = mvttimes_pref,
                         p_alpha    = pref_glm_use,
                         opt_or_dur = 'duration',
...
ut3_alpha_2b = optimize(fun_optim_prx_logit_ut3,
                      masses     = masses,
                      mvttimes   = mvttimes_smallt,
                      p_alpha    = smallt_glm_use,
                      rxtimes    = rxtimes_smallt,
...
ut3_dur_2b = as.numeric(fun_optim_prx_logit_ut3(
                           alpha      = ut3_alpha_2b$minimum, #changing between alpha_pref and alpha_smallt_gross
                           masses     = masses,
                           mvttimes   = mvttimes_smallt,
                           p_alpha    = smallt_glm_use,
                           rxtimes    = rxtimes_smallt,
...
ut3_alpha_2c = optimize(fun_optim_prx_ut3,
                     masses     = masses,
                     mvttimes   = mvttimes_pilot,
                     p_alpha    = p_alpha_pilot_gross,
                     rxtimes    = rxtimes_pilot,
...
ut3_dur_2c = as.numeric(fun_optim_prx_ut3(
                          alpha      = ut3_alpha_2c$minimum,
                          masses     = masses,
                          mvttimes   = mvttimes_pilot,
                          p_alpha    = p_alpha_pilot_gross,
                          rxtimes    = rxtimes_pilot,
...
# Using logit function
ut4_alpha_2a = optimize(fun_optim_prx_logit_ut2,
                      masses     = masses,
                      mvttimes   = mvttimes_pref,
                      p_alpha    = pref_glm_use,
                      rxtimes    = rxtimes_pref,
...
ut4_dur_2a = as.numeric(fun_optim_prx_logit_ut2(
                         alpha      = ut4_alpha_2a$minimum,
                         masses     = masses,
                         mvttimes   = mvttimes_pref,
                         p_alpha    = pref_glm_use,
                         opt_or_dur = 'duration',
...
ut4_alpha_2b = optimize(fun_optim_prx_logit_ut2,
                      masses     = masses,
                      mvttimes   = mvttimes_smallt,
                      p_alpha    = smallt_glm_use,
                      rxtimes    = rxtimes_smallt,
...
ut4_dur_2b = as.numeric(fun_optim_prx_logit_ut2(
                           alpha      = ut4_alpha_2b$minimum, #changing between alpha_pref and alpha_smallt_gross
                           masses     = masses,
                           mvttimes   = mvttimes_smallt,
                           p_alpha    = smallt_glm_use,
                           rxtimes    = rxtimes_smallt,
...
ut4_alpha_2c = optimize(fun_optim_prx_ut2,
                     masses     = masses,
                     mvttimes   = mvttimes_pilot,
                     p_alpha    = p_alpha_pilot_gross,
                     rxtimes    = rxtimes_pilot,
...
ut4_dur_2c = as.numeric(fun_optim_prx_ut2(
                          alpha      = ut4_alpha_2c$minimum,
                          masses     = masses,
                          mvttimes   = mvttimes_pilot,
                          p_alpha    = p_alpha_pilot_gross,
                          rxtimes    = rxtimes_pilot,
...
# Using logit function
ut5_alpha_2a = optimize(fun_optim_prx_logit_ut3,
                        masses     = masses,
                        mvttimes   = mvttimes_pref,
                        p_alpha    = pref_glm_use,
                        rxtimes    = rxtimes_pref,
...
ut5_dur_2a = as.numeric(fun_optim_prx_logit_ut3(
                        alpha      = ut5_alpha_2a$minimum,
                        masses     = masses,
                        mvttimes   = mvttimes_pref,
                        p_alpha    = pref_glm_use,
                        opt_or_dur = 'duration',
...
ut5_alpha_2b = optimize(fun_optim_prx_logit_ut3,
                        masses     = masses,
                        mvttimes   = mvttimes_smallt,
                        p_alpha    = smallt_glm_use,
                        rxtimes    = rxtimes_smallt,
...
ut5_dur_2b = as.numeric(fun_optim_prx_logit_ut3(
                        alpha      = ut5_alpha_2b$minimum, #changing between alpha_pref and alpha_smallt_gross
                        masses     = masses,
                        mvttimes   = mvttimes_smallt,
                        p_alpha    = smallt_glm_use,
                        rxtimes    = rxtimes_smallt,
...
ut5_alpha_2c = optimize(fun_optim_prx_ut3,
                        masses     = masses,
                        mvttimes   = mvttimes_pilot,
                        p_alpha    = p_alpha_pilot_gross,
                        rxtimes    = rxtimes_pilot,
...
ut5_dur_2c = as.numeric(fun_optim_prx_ut3(
                        alpha      = ut5_alpha_2c$minimum,
                        masses     = masses,
                        mvttimes   = mvttimes_pilot,
                        p_alpha    = p_alpha_pilot_gross,
                        rxtimes    = rxtimes_pilot,
...
ut1_alpha_2a2b = alpha_pref_comb_gross
ut1_dur_2a2b   = util_dur_pref_alpha_comb_gross

ut1_dur_2a2b2c = as.numeric(fun_optim_prx(
                          alpha    = alpha_pref_comb_gross$minimum,
                          masses   = masses,
                          mvttimes = mvttimes_pilot,
                          p_alpha  = p_alpha_pilot_gross,
...
c=coef(MPGross_model)[3]
d=coef(MPGross_model)[4]
ut2_alpha_2a2b=optimize(fun_optim_prx_logit_comb_ut2,
              masses     = c(masses,masses),
              mvttimes   = c(mvttimes_pref,mvttimes_smallt),
              glm1       = pref_glm_use,
              glm2       = smallt_glm_use,
...
ut2_dur_2a2b = as.numeric(fun_optim_prx_logit_comb_ut2(
               alpha      = ut2_alpha_2a2b$minimum,
               masses     = c(masses,masses),
               mvttimes   = c(mvttimes_pref,mvttimes_smallt),
               glm1       = pref_glm_use,
               glm2       = smallt_glm_use,
...
ut2_dur_2a2b2c = as.numeric(fun_optim_prx_ut2(
                          alpha    = ut2_alpha_2a2b$minimum,
                          masses   = masses,
                          mvttimes = mvttimes_pilot,
                          p_alpha  = p_alpha_pilot_gross,
...
c=coef(MPGross_model)[3]
d=coef(MPGross_model)[4]
ut3_alpha_2a2b = optimize(fun_optim_prx_logit_comb_ut3,
              masses     = c(masses,masses),
              mvttimes   = c(mvttimes_pref,mvttimes_smallt),
              glm1       = pref_glm_use,
              glm2       = smallt_glm_use,
...
ut3_dur_2a2b = as.numeric(fun_optim_prx_logit_comb_ut3(
               alpha      = ut3_alpha_2a2b$minimum,
               masses     = c(masses,masses),
               mvttimes   = c(mvttimes_pref,mvttimes_smallt),
               glm1       = pref_glm_use,
               glm2       = smallt_glm_use,
...
ut3_dur_2a2b2c = as.numeric(fun_optim_prx_ut3(
                          alpha    = ut3_alpha_2a2b$minimum,
                          masses   = masses,
                          mvttimes = mvttimes_pilot,
                          p_alpha  = p_alpha_pilot_gross,
...
ut4_alpha_2a2b=optimize(fun_optim_prx_logit_comb_ut2,
                        masses     = c(masses,masses),
                        mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                        glm1       = pref_glm_use,
                        glm2       = smallt_glm_use,
...
ut4_dur_2a2b = as.numeric(fun_optim_prx_logit_comb_ut2(
                          alpha      = ut4_alpha_2a2b$minimum,
                          masses     = c(masses,masses),
                          mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                          glm1       = pref_glm_use,
                          glm2       = smallt_glm_use,
...
ut4_dur_2a2b2c = as.numeric(fun_optim_prx_ut2(
                            alpha    = ut4_alpha_2a2b$minimum,
                            masses   = masses,
                            mvttimes = mvttimes_pilot,
                            p_alpha  = p_alpha_pilot_gross,
...
c=coef(MPNet_model)[3]
d=coef(MPNet_model)[4]
ut5_alpha_2a2b = optimize(fun_optim_prx_logit_comb_ut3,
                          masses     = c(masses,masses),
                          mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                          glm1       = pref_glm_use,
                          glm2       = smallt_glm_use,
...
ut5_dur_2a2b = as.numeric(fun_optim_prx_logit_comb_ut3(
                          alpha      = ut5_alpha_2a2b$minimum,
                          masses     = c(masses,masses),
                          mvttimes   = c(mvttimes_pref,mvttimes_smallt),
                          glm1       = pref_glm_use,
                          glm2       = smallt_glm_use,
...
ut5_dur_2a2b2c = as.numeric(fun_optim_prx_ut3(
                            alpha    = ut5_alpha_2a2b$minimum,
                            masses   = masses,
                            mvttimes = mvttimes_pilot,
                            p_alpha  = p_alpha_pilot_gross,
...
rownames(movedurs) = c('2.44 kg','3.80 kg','4.70 kg','6.10 kg')
...
rownames(reacttimes) = c('2.44 kg','3.80 kg','4.70 kg','6.10 kg')
...
This section analysis fits two $\alpha$ values to experiment 2a and 2b.
...
The $\alpha$ value fitted here is `r alpha_utility_gross_rx$minimum` for 2a, and for 2b is `r alpha_smallt_gross`, and 2c `r alpha_pilot_gross`.

The SSE for experiment 2a is `r formatC(sum((mvttimes_pref-util_dur_gross_rx)^2),format = 'e', digits = 3)`.
The SSE for experiment 2b is `r formatC(sum((mvttimes_smallt-util_dur_smallt_gross)^2),format = 'e', digits = 3)`.
The SSE for experiment 2a/b is `r formatC(sum((mvttimes_smallt-util_dur_smallt_gross)^2)+sum((mvttimes_smallt-util_dur_smallt_gross)^2),format = 'e', digits = 3)`.
The SSE for experiment 2c is `r formatC(sum((util_dur_pilot_gross-mvttimes_pilot)^2),format = 'e', digits = 3)`. 

The total SSE for all 3 is `r formatC(sum((mvttimes_pref-util_dur_gross_rx)^2)+sum((mvttimes_smallt-util_dur_smallt_gross)^2)+sum((util_dur_pilot_gross-mvttimes_pilot)^2),format = 'e', digits = 3)`.

```{r, echo = FALSE, warning = FALSE}

comb_ut_probtab_3alphas = cbind(round(inv.logit(predict(pref_glm_use,
                                                data.frame(movedur=util_dur_gross_rx,eff_mass=masses))),4),
                        round(inv.logit(predict(smallt_glm_use,
                                                data.frame(movedur=util_dur_smallt_gross,eff_mass=masses))),4),
                        c(1,1,1,1))
colnames(comb_ut_probtab_3alphas) = c('2a','2b','2c')
rownames(comb_ut_probtab_3alphas) = unique(prefdata$eff_mass)

comb_ut_durtab_3alphas = cbind(mvttimes_pref,
                               util_dur_gross_rx,
                               mvttimes_smallt,
                               util_dur_smallt_gross,
                               mvttimes_pilot,
                               util_dur_pilot_gross)
colnames(comb_ut_durtab_3alphas) = c('2a Exp','2a pred','2b Exp','2b pred','2c Exp','2c pred')
rownames(comb_ut_durtab_3alphas) = unique(prefdata$eff_mass)

alph_tab_3alphas = cbind(round(alpha_utility_gross_rx$minimum,3), round(alpha_smallt_gross$minimum,3), round(alpha_pilot_gross$minimum,3))
colnames(alph_tab_3alphas) = c('2a','2b','2c')
rownames(alph_tab_3alphas) = '\alpha'

```

```{r combutdurtab1_3alphas, echo = FALSE, warning = FALSE, tab.cap = 'Experimental and predicted movement durations for the experiments.'}
kable(comb_ut_durtab_3alphas, caption = 'Experimental and predicted movement durations for the experiments.')
```

```{r combutprobtab1_3alphas, echo = FALSE, warning = FALSE, tab.cap = 'Probabilites of success for the experiments.'}
kable(comb_ut_probtab_3alphas, caption = 'Probabilites of success for the experiments.')
```

```{r alphtab1_3alphas, echo = FALSE, warning = FALSE, tab.cap = 'Alpha values fitted to experiment 2a/2b, and a seperate alpha for 2c.'}
kable(alph_tab_3alphas, caption = 'Alpha values fitted to experiment 2a/2b, and a seperate alpha for 2c.')
```
...
control_times = rbind(cbind(rep('smallt',4),rep('data',4),c(2.5,3.8,4.7,6.1),mvttimes_smallt,rep(3,4),mvttimes_smallt_se),
                      ...
                      cbind(rep('smallt',4),rep('model',4),c(2.5,3.8,4.7,6.1),util_dur_smallt_gross,rep(3,4),rep(0,4)),
                      cbind(rep('pref',4),rep('model',4),c(2.5,3.8,4.7,6.1),util_dur_gross_rx,rep(1,4),rep(0,4)),
...
ut_2a_tab = cbind(c('alpha',unique(prefdata$eff_mass),'SSE'),
              ...
              c(round(ut1_alpha_2a$minimum,3),ut1_dur_2a,sse_fun(ut1_dur_2a,mvttimes_pref)),
              c(round(ut2_alpha_2a$minimum,3),ut2_dur_2a,sse_fun(ut2_dur_2a,mvttimes_pref)),
              c(round(ut3_alpha_2a$minimum,3),ut3_dur_2a,sse_fun(ut3_dur_2a,mvttimes_pref)),
              c(round(ut4_alpha_2a$minimum,3),ut4_dur_2a,sse_fun(ut4_dur_2a,mvttimes_pref)),
              c(round(ut5_alpha_2a$minimum,3),ut5_dur_2a,sse_fun(ut5_dur_2a,mvttimes_pref)),
              c(round(ut1_alpha_2a2b$minimum,3),ut1_dur_2a2b[1:4],sse_fun(ut1_dur_2a2b[1:4],mvttimes_pref)),
              c(round(ut2_alpha_2a2b$minimum,3),ut2_dur_2a2b[1:4],sse_fun(ut2_dur_2a2b[1:4],mvttimes_pref)),
              c(round(ut3_alpha_2a2b$minimum,3),ut3_dur_2a2b[1:4],sse_fun(ut3_dur_2a2b[1:4],mvttimes_pref)),
              c(round(ut4_alpha_2a2b$minimum,3),ut4_dur_2a2b[1:4],sse_fun(ut4_dur_2a2b[1:4],mvttimes_pref)),
              c(round(ut5_alpha_2a2b$minimum,3),ut5_dur_2a2b[1:4],sse_fun(ut5_dur_2a2b[1:4],mvttimes_pref))
              )
colnames(ut_2a_tab)<-c('eff_mass','Movement Duration (s)',
                       ...
                       'Utility 4 Duration',
                       'Utility 5 Duration',
                       'Utility Comb 1 Duration',
                       'Utility Comb 2 Duration',
                       'Utility Comb 3 Duration',
                       'Utility Comb 4 Duration',
                       'Utility Comb 5 Duration'
                       )
...
ut_2a_df = as.data.frame(rbind(cbind(masses,rep('Exp',4),mvttimes_pref),
                 cbind(masses,rep('Ut1',4),ut1_dur_2a),
                 cbind(masses,rep('Ut2',4),ut2_dur_2a),
                 cbind(masses,rep('Ut3',4),ut3_dur_2a),
                 cbind(masses,rep('Ut4',4),ut4_dur_2a),
                 cbind(masses,rep('Ut5',4),ut5_dur_2a),
                 cbind(masses,rep('Utcomb1',4),ut1_dur_2a2b[1:4]),
                 cbind(masses,rep('Utcomb2',4),ut2_dur_2a2b[1:4]),
                 cbind(masses,rep('Utcomb3',4),ut3_dur_2a2b[1:4]),
                 cbind(masses,rep('Utcomb4',4),ut4_dur_2a2b[1:4]),
                 cbind(masses,rep('Utcomb5',4),ut5_dur_2a2b[1:4])) %>% `colnames<-`(c('eff_mass','data','movedur')))
ut_2a_df$movedur = as.numeric(as.character(ut_2a_df$movedur))
ut_2a_df$data = as.factor(ut_2a_df$data)

ut_2a_plot <- ggplot()+
  geom_line(data = ut_2a_df,
             aes(x = eff_mass,
                 y = movedur,
                 group = factor(data),
                 color = factor(data)),
            size = 1)+
  geom_point(data=ut_2a_df,
             aes(x = eff_mass,
                 y = movedur,
                 color = factor(data)),
            size = 2)+
  geom_point(data=filter(ut_2a_df,data=='Exp'),
             aes(x = eff_mass,
                 y = movedur),
             color = gg_color_hue(11)[1],
             size = 5)+
  geom_line(data=filter(ut_2a_df,data=='Exp'),
            aes(x = eff_mass,
                y = movedur,
                group = data),
            color = gg_color_hue(11)[1],
            size = 2)+
  geom_text(data = filter(ut_2a_df, eff_mass == 2.506),
            aes(x = eff_mass,
                y = movedur,
                label = data))+
  scale_color_manual(values = gg_color_hue(11))+
  labs(x = 'Effective Mass (kg)', y = '2a Movement Duration (s)', color = 'Data')#, title = 'ut2/ut3 not shown cause it doesn\'t fit.')
  
#2b =========================================================
ut_2b_tab = cbind(c('alpha',unique(prefdata$eff_mass),'SSE'),
                  c('alpha',round(mvttimes_smallt,4),'SSE'),
                  c(round(ut1_alpha_2b$minimum,3),ut1_dur_2b,sse_fun(ut1_dur_2b,mvttimes_smallt)),
                  c(round(ut2_alpha_2b$minimum,3),ut2_dur_2b,sse_fun(ut2_dur_2b,mvttimes_smallt)),
                  c(round(ut3_alpha_2b$minimum,3),ut3_dur_2b,sse_fun(ut3_dur_2b,mvttimes_smallt)),
                  c(round(ut4_alpha_2b$minimum,3),ut4_dur_2b,sse_fun(ut4_dur_2b,mvttimes_smallt)),
                  c(round(ut5_alpha_2b$minimum,3),ut5_dur_2b,sse_fun(ut5_dur_2b,mvttimes_smallt)),
                  c(round(ut1_alpha_2a2b$minimum,3),ut1_dur_2a2b[5:8],sse_fun(ut1_dur_2a2b[5:8],mvttimes_smallt)),
                  c(round(ut2_alpha_2a2b$minimum,3),ut2_dur_2a2b[5:8],sse_fun(ut2_dur_2a2b[5:8],mvttimes_smallt)),
                  c(round(ut3_alpha_2a2b$minimum,3),ut3_dur_2a2b[5:8],sse_fun(ut3_dur_2a2b[5:8],mvttimes_smallt)),
                  c(round(ut4_alpha_2a2b$minimum,3),ut4_dur_2a2b[5:8],sse_fun(ut4_dur_2a2b[5:8],mvttimes_smallt)),
                  c(round(ut5_alpha_2a2b$minimum,3),ut5_dur_2a2b[5:8],sse_fun(ut5_dur_2a2b[5:8],mvttimes_smallt)))
...
ut_2b_df = as.data.frame(rbind(cbind(masses,rep('Exp',4),mvttimes_smallt),
                               cbind(masses,rep('Ut1',4),ut1_dur_2b),
                               cbind(masses,rep('Ut2',4),ut2_dur_2b),
                               cbind(masses,rep('Ut3',4),ut3_dur_2b),
                               cbind(masses,rep('Ut4',4),ut4_dur_2b),
                               cbind(masses,rep('Ut5',4),ut5_dur_2b),
                               cbind(masses,rep('Utcomb1',4),ut1_dur_2a2b[5:8]),
                               cbind(masses,rep('Utcomb2',4),ut2_dur_2a2b[5:8]),
                               cbind(masses,rep('Utcomb3',4),ut3_dur_2a2b[5:8]),
                               cbind(masses,rep('Utcomb4',4),ut4_dur_2a2b[5:8]),
                               cbind(masses,rep('Utcomb5',4),ut5_dur_2a2b[5:8])) %>% `colnames<-`(c('eff_mass','data','movedur')))
ut_2b_df$movedur = as.numeric(as.character(ut_2b_df$movedur))
ut_2b_df$data = as.factor(ut_2b_df$data)

ut_2b_plot <- ggplot()+
  geom_line(data = ut_2b_df,
            aes(x = eff_mass,
                y = movedur,
                group = factor(data),
                color = factor(data)),
            size = 1)+
  geom_point(data=ut_2b_df,
             aes(x = eff_mass,
                 y = movedur,
                 color = factor(data)),
             size = 2)+
  geom_point(data=filter(ut_2b_df,data=='Exp'),
             aes(x = eff_mass,
                 y = movedur),
             color = gg_color_hue(11)[1],
             size = 5)+
  geom_line(data=filter(ut_2b_df,data=='Exp'),
            aes(x = eff_mass,
                y = movedur,
                group = data),
            color = gg_color_hue(11)[1],
            size = 2)+
  geom_text(data = filter(ut_2b_df, eff_mass == 2.506),
            aes(x = eff_mass,
                y = movedur,
                label = data))+
  scale_color_manual(values = gg_color_hue(11))+
  labs(x = 'Effective Mass (kg)', y = '2b Movement Duration (s)', color = 'Data')#, title = 'ut2/ut3 not shown cause it doesn\'t fit.')

#2c =========================================================
ut_2c_tab = cbind(c('alpha',unique(prefdata$eff_mass),'SSE'),
                  c('alpha',round(mvttimes_pilot,4),'SSE'),
                  c(round(ut1_alpha_2c$minimum,3),ut1_dur_2c,sse_fun(ut1_dur_2b,mvttimes_pilot)),
                  c(round(ut2_alpha_2c$minimum,3),ut2_dur_2c,sse_fun(ut2_dur_2b,mvttimes_pilot)),
                  c(round(ut3_alpha_2c$minimum,3),ut3_dur_2c,sse_fun(ut3_dur_2b,mvttimes_pilot)),
                  c(round(ut4_alpha_2c$minimum,3),ut4_dur_2c,sse_fun(ut4_dur_2b,mvttimes_pilot)),
                  c(round(ut5_alpha_2c$minimum,3),ut5_dur_2c,sse_fun(ut5_dur_2b,mvttimes_pilot)),
                  c(round(ut1_alpha_2a2b$minimum,3),ut1_dur_2a2b2c,sse_fun(ut1_dur_2a2b2c,mvttimes_pilot)),
                  c(round(ut2_alpha_2a2b$minimum,3),ut2_dur_2a2b2c,sse_fun(ut2_dur_2a2b2c,mvttimes_pilot)),
                  c(round(ut3_alpha_2a2b$minimum,3),ut3_dur_2a2b2c,sse_fun(ut3_dur_2a2b2c,mvttimes_pilot)),
                  c(round(ut4_alpha_2a2b$minimum,3),ut4_dur_2a2b2c,sse_fun(ut4_dur_2a2b2c,mvttimes_pilot)),
                  c(round(ut5_alpha_2a2b$minimum,3),ut5_dur_2a2b2c,sse_fun(ut5_dur_2a2b2c,mvttimes_pilot)))
...
ut_2c_df = as.data.frame(rbind(cbind(masses,rep('Exp',4),mvttimes_pilot),
                               cbind(masses,rep('Ut1',4),ut1_dur_2c),
                               cbind(masses,rep('Ut2',4),ut2_dur_2c),
                               cbind(masses,rep('Ut3',4),ut3_dur_2c),
                               cbind(masses,rep('Ut4',4),ut4_dur_2c),
                               cbind(masses,rep('Ut5',4),ut5_dur_2c),
                               cbind(masses,rep('Utcomb1',4),ut1_dur_2a2b2c),
                               cbind(masses,rep('Utcomb2',4),ut2_dur_2a2b2c),
                               cbind(masses,rep('Utcomb3',4),ut3_dur_2a2b2c),
                               cbind(masses,rep('Utcomb4',4),ut4_dur_2a2b2c),
                               cbind(masses,rep('Utcomb5',4),ut5_dur_2a2b2c)) %>% `colnames<-`(c('eff_mass','data','movedur')))
ut_2c_df$movedur = as.numeric(as.character(ut_2c_df$movedur))
ut_2c_df$data = as.factor(ut_2c_df$data)

ut_2c_plot <- ggplot()+
  geom_line(data = ut_2c_df,
            aes(x = eff_mass,
                y = movedur,
                group = factor(data),
                color = factor(data)),
            size = 1)+
  geom_point(data=ut_2c_df,
             aes(x = eff_mass,
                 y = movedur,
                 color = factor(data)),
             size = 2)+
  geom_point(data=filter(ut_2c_df,data=='Exp'),
             aes(x = eff_mass,
                 y = movedur),
             color = gg_color_hue(11)[1],
             size = 5)+
  geom_line(data=filter(ut_2c_df,data=='Exp'),
            aes(x = eff_mass,
                y = movedur,
                group = data),
            color = gg_color_hue(11)[1],
            size = 2)+
  scale_color_manual(values = gg_color_hue(11))+
  geom_text(data = filter(ut_2c_df, eff_mass == 2.506),
            aes(x = eff_mass,
                y = movedur,
                label = data))+
  labs(x = 'Effective Mass (kg)', y = '2c Movement Duration (s)', color = 'Data')#, title = 'ut2/ut3 not shown cause it doesn\'t fit.')

```

```{r altutilitymodels, echo = FALSE, warning = FALSE, fig.height=10, fig.width = 9, fig.cap = 'Alternative utility models for 2a, 2b, and 2c.'}
alt_ut_mod <- plot_grid(plot_grid(ut_2a_plot+theme(legend.position = 'none'),
                    ut_2b_plot+theme(legend.position = 'none'),
                    ut_2c_plot+theme(legend.position = 'none'),
                    nrow = 3),
          get_legend(ut_2a_plot),
          ncol = 2,
          rel_widths = c(4,1))
alt_ut_mod
...
```{r SSEaltutilitymodels, echo = FALSE, warning = FALSE, fig.height=6, fig.width = 9, fig.cap = 'SSE Alternative utility models for 2a, 2b, and 2c.'}

alt_ut_sse_df = rbind(cbind(rep('2a',10),
                            levels(ut_2a_df$data)[2:11],
                            c(sse_fun(ut1_dur_2a,mvttimes_pref),
                              sse_fun(ut2_dur_2a,mvttimes_pref),
                              sse_fun(ut3_dur_2a,mvttimes_pref),
                              sse_fun(ut4_dur_2a,mvttimes_pref),
                              sse_fun(ut5_dur_2a,mvttimes_pref),
                              sse_fun(ut1_dur_2a2b[1:4],mvttimes_pref),
                              sse_fun(ut2_dur_2a2b[1:4],mvttimes_pref),
                              sse_fun(ut3_dur_2a2b[1:4],mvttimes_pref),
                              sse_fun(ut4_dur_2a2b[1:4],mvttimes_pref),
                              sse_fun(ut5_dur_2a2b[1:4],mvttimes_pref))),
                      cbind(rep('2b',10),
                            levels(ut_2b_df$data)[2:11],
                            c(sse_fun(ut1_dur_2b,mvttimes_smallt),
                              sse_fun(ut2_dur_2b,mvttimes_smallt),
                              sse_fun(ut3_dur_2b,mvttimes_smallt),
                              sse_fun(ut4_dur_2b,mvttimes_smallt),
                              sse_fun(ut5_dur_2b,mvttimes_smallt),
                              sse_fun(ut1_dur_2a2b[5:8],mvttimes_smallt),
                              sse_fun(ut2_dur_2a2b[5:8],mvttimes_smallt),
                              sse_fun(ut3_dur_2a2b[5:8],mvttimes_smallt),
                              sse_fun(ut4_dur_2a2b[5:8],mvttimes_smallt),
                              sse_fun(ut5_dur_2a2b[5:8],mvttimes_smallt))),
                      cbind(rep('2c',10),
                            levels(ut_2a_df$data)[2:11],
                            c(sse_fun(ut1_dur_2c,mvttimes_pilot),
                              sse_fun(ut2_dur_2c,mvttimes_pilot),
                              sse_fun(ut3_dur_2c,mvttimes_pilot),
                              sse_fun(ut4_dur_2c,mvttimes_pilot),
                              sse_fun(ut5_dur_2c,mvttimes_pilot),
                              sse_fun(ut1_dur_2a2b2c,mvttimes_pilot),
                              sse_fun(ut2_dur_2a2b2c,mvttimes_pilot),
                              sse_fun(ut3_dur_2a2b2c,mvttimes_pilot),
                              sse_fun(ut4_dur_2a2b2c,mvttimes_pilot),
                              sse_fun(ut5_dur_2a2b2c,mvttimes_pilot))))
...
ggplot()+
  ...
  geom_text(data=alt_ut_sse_df,
            ...
            angle = 90,
            hjust = -.1)+
  labs(x = 'Experiment', y = 'abs(log(SSE))), Higher is better', fill = 'Utility\nModel')
