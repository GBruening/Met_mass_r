...
```{r, echo = FALSE, warning = FALSE}
#2a =========================================================
ut_2a_tab = cbind(unique(prefdata$eff_mass),
              mvttimes_pref,
              ut1_dur_2a,
              ut2_dur_2a,
              ut3_dur_2a,
...
#2b =========================================================
ut_2b_tab = cbind(unique(prefdata$eff_mass),
              mvttimes_pref,
              ut1_dur_2b,
              ut2_dur_2b,
              ut3_dur_2b,
...
#2c =========================================================
ut_2c_tab = cbind(unique(prefdata$eff_mass),
              mvttimes_pilot,
              ut1_dur_2c,
              ut2_dur_2c,
              ut3_dur_2c)
colnames(ut_2c_tab)<-c('eff_mass',colnames(ut_2c_tab)[2:5])
kable(ut_2c_tab %>% `colnames<-`(c('eff_mass','MOvement Duration (s)','Utility 1 Duration','Utility 2 Duration','Utility 3 Duration')),
...
```{r altutilitymodels, echo = FALSE, warning = FALSE, fig.height=8, fig.width = 6, fig.cap = 'Alternative utility models for 2a, 2b, and 2c.'}
