...
missangle_by_experiement <- all_exp_avg_plot_addmass('missangle',miss_var_pref,miss_var_smallt,miss_var_pilot,ylab = expression(atop(Miss~Angle~Variance~(deg^2))))
...
miss_rad_by_experiement <- all_exp_avg_plot_addmass('miss_rad',miss_var_pref,miss_var_smallt,miss_var_pilot,ylab = expression(atop(Miss~Radial~Variance~(cm^2))))
...
```{r Peakvelbyexperiment, echo = FALSE, warning = FALSE, fig.width=12, fig.height=8, fig.cap = 'Peak Velocity by experiment.'}
  ...
  Peakvel_by_experiment <- all_exp_avg_plot_addmass('peakvel_target',prefdata,smalltdata,pilotdata,ylab = 'Peak Velocity (m/s)')
...
Miss_dist_norm_by_experiment <- all_exp_avg_plot_addmass('miss_dist_norm',prefdata,smalltdata,pilotdata,ylab = 'Miss Distance Normalized (m/s)')
...
<!-- all_exp_avg_plot_addmass('miss_dist_sd',prefdata,smalltdata,pilotdata,ylab = 'Miss Dist SD Average') -->
...
<!-- all_exp_avg_plot_addmass('missangle_sd',prefdata,smalltdata,pilotdata,ylab = 'Miss Angle standard deviation Average') -->
...
<!-- all_exp_avg_plot_addmass('miss_rad_sd',prefdata,smalltdata,pilotdata,ylab = 'Miss Angle standard deviation Average') -->
...
all_exp_avg_plot_addmass('success',prefdata,smalltdata,smalltdata,ylab = 'Success Probabolity')
```
