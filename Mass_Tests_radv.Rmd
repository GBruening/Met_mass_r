...
#====================== LOAD DATA ==============================
# parent_directory = 'D:/Google Drive/Preferred Mass/alaa code'
parent_directory = 'd:/Users/Gary/Google Drive/Preferred Mass/alaa code'
...
resamp_plots[['pref']] <- resample_plot(resample_data_pref_abs,250)+
  scale_y_continuous(limits = c(-.0001,0.28),
                     breaks = c(0,0,0.05,0.1,0.15,0.20,0.25,0.30),
                     labels = c(0,0,0.05,0.1,0.15,0.20,0.25,0.30))+
  theme(legend.position='none')+
  theme(text              = element_text(color='black'),
        axis.text         = element_text(color='black'),
        axis.ticks        = element_line(color='black'),
...
resamp_plots[['pilot']] <- resample_plot(resample_data_pilot_abs,250)+
  scale_y_continuous(limits = c(-.0001,0.28),
                     breaks = c(0,0,0.05,0.1,0.15,0.20,0.25,0.30),
                     labels = c(0,0,0.05,0.1,0.15,0.20,0.25,0.30))+
  # scale_y_continuous(breaks = c(-0.10,-0.05,0,0,0.05,0.1,0.15,0.20,0.25,0.30),
  #                    labels = c(-0.10,-0.05,0,0,0.05,0.1,0.15,0.20,0.25,0.30))+
  theme(legend.position='none')+
  theme(text              = element_text(color='black'),
        axis.text         = element_text(color='black'),
        axis.ticks        = element_line(color='black'),
...
setwd(pref_plots_dir)
if (save_plots){
  ggsave('Pref_results_grouped.pdf',plot=pref_grouped,width=9/.9,height=9, useDingbats = FALSE)
}
...
ut4_grs_dur_2a2b2c = c(ut4_grs_dur_2a,ut4_grs_dur_2b,ut4_grs_dur_2c)
...
```{r altutilitymodelsOneAlpha, echo = FALSE, warning = FALSE, fig.height=10, fig.width = 9, fig.cap = 'Alternative utility models for 2a, 2b, and 2c.'}

alt_ut_mod <- plot_grid(alt_ut_plots[['2a_abs']]+theme(legend.position = 'none'),
                        alt_ut_plots[['2b_abs']]+theme(legend.position = 'none'),
                        alt_ut_plots[['2c_abs']]+theme(legend.position = 'none'),
                        get_legend(alt_ut_plots[['2a_abs']]),
                        ncol = 2)
alt_ut_mod
...
```{r altutilitymodelsdiffOneAlpha, echo = FALSE, warning = FALSE, fig.height=10, fig.width = 10, fig.cap = 'Alternative utility model difference from experimental for 2a, 2b, and 2c.'}

alt_ut_mod_diff <- plot_grid(alt_ut_plots[['2a_diff']]+theme(legend.position = 'none'),
                             alt_ut_plots[['2b_diff']]+theme(legend.position = 'none'),
                             alt_ut_plots[['2c_diff']]+theme(legend.position = 'none'),
                             get_legend(alt_ut_plots[['2a_diff']]),
                        ncol = 2)
alt_ut_mod_diff
...
```{r altutilitymodelsTwoAlpha, echo = FALSE, warning = FALSE, fig.height=10, fig.width = 9, fig.cap = 'Alternative utility models for 2a, 2b, and 2c.'}
...
```{r altutilitymodelsdiffTwoAlpha, echo = FALSE, warning = FALSE, fig.height=10, fig.width = 10, fig.cap = 'Alternative utility model difference from experimental for 2a, 2b, and 2c.'}
...
#### One alpha value
This next plot is showing the total SSE when fitting one alpha to 2a/2b, then another alpha to 2c. 

```{r, echo = FALSE, warning = FALSE}

alt_ut_sse_spec_df = rbind(cbind(rep('2a',6),
                            c(1, 2, 4, 5, 6, 3),
                            c('Utility Gross',
                              'Utility Net',
                              'Speed-Acc w/ Cost',
...
```{r altutilitymodelSSEgroupplot, echo = FALSE, warning = FALSE,fig.height = 10, fig.width = 6}
...
alt_ut_sse_spec_df_norm = rbind(cbind(rep('2a',6),
                                 c(1, 2, 4, 5, 6, 3),
                                 c('Utility Gross',
                                   'Utility Net',
                                   'Speed-Acc w/ Cost',
...
```{r AltUtPlotGrouped, echo = FALSE, warning = FALSE,fig.height = 10, fig.width = 6}
...
alt_ut_sse_spec_df = rbind(cbind(rep('2a',6),
                            ...
                            c(sse_fun(ut1_grs_dur_2a2b[1:4],mvttimes_pref),
                              ...
                              sse_fun(met_gross_dur,mvttimes_pref),
                              sse_fun(met_net_dur,mvttimes_pref),
                              sse_fun(torque_dur_2a,mvttimes_pref))),
                      cbind(rep('2b',6),
                            c('Ut1combgrs',
                              'Ut1combnet',
                              'Ut2combgrs',
                            ...
                            c(sse_fun(ut1_grs_dur_2a2b[5:8],mvttimes_smallt),
                              ...
                              sse_fun(met_gross_dur,mvttimes_smallt),
                              sse_fun(met_net_dur,mvttimes_smallt),
                              sse_fun(torque_dur_2b,mvttimes_smallt))),
                      cbind(rep('2c',6),
                            c('Ut1combgrs',
                              'Ut1combnet',
                              'Ut2combgrs',
                            ...
                            c(sse_fun(ut1_grs_dur_2c,mvttimes_pilot),
                              ...
                              sse_fun(met_gross_dur,mvttimes_pilot),
                              sse_fun(met_net_dur,mvttimes_pilot),
                              sse_fun(torque_dur_2c,mvttimes_pilot))))

colnames(alt_ut_sse_spec_df) <- c('exp','utmod','sse')
alt_ut_sse_spec_df = as.data.frame(alt_ut_sse_spec_df)
alt_ut_sse_spec_df$sse = as.numeric(as.character(alt_ut_sse_spec_df$sse))

ggplot(data=aggregate(sse ~ utmod, alt_ut_sse_spec_df, sum))+
  geom_bar(aes(x = utmod,
               y = sse,
               fill = factor(utmod)),
           color = 'black',
